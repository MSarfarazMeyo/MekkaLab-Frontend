    ...
    <AppBar >
      <Toolbar className={classes.toolbar}>
        ...
        <Box  className='main-b' >
          ...
          <Typography className='salona'  sx={{ fontFamily: "Poppins"}}><span style={{color: "#C615A9",marginRight:"4px"}}> Salona Network</span> </Typography>
          <Typography className='num' mr={2} sx={{ color: "#C615A9" }}> <span style={{color: "#C615A9",marginRight:"4px"}}>  968554</span> </Typography>
